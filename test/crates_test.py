...
from config import Song, xfail_new_feature_crates, skip_not_implemented # noqa: F401, E261
from test.lyrics.whole_song_crates import song_lyrics, verses   # noqa: F401, E261


@pytest.mark.xfail(xfail_new_feature_crates, reason="new feature crate")
def test_4_crates():
...
@pytest.mark.xfail(skip_not_implemented, reason="new feature crate")
